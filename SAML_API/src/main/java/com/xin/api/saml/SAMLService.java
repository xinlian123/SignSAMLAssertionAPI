...
public class SAMLService {
	...
	List<SAMLInfo> samlInfo = new ArrayList<> (Arrays.asList(
			new SAMLInfo("https://qaaccess.creditacceptance.com:8443/openam", "google.com")
			
			));
	
	public static String getFRAPI(String val) {
	...
	public List<SAMLInfo> getInfo(){
		return samlInfo;
	}
	
	public  String signedSamlResponse(String api) throws UnsupportedEncodingException, XPathExpressionException, XMLSecurityException{
		SAMLService res = new SAMLService();
		
		String unsignedSAMLResponseInXML   = res.SAMLResponse(api);			
		...
		//System.out.println(FRAPIValue);
		//res.post(encodedSignedSAMLResponse);
		
		return encodedSignedSAMLResponse;
	}
...
//Generate SAML Response	
	public String SAMLResponse(String APIValue) {
		...
		String assertion = APIValue.replace("\\","");
